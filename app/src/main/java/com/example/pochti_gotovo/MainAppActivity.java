package com.example.pochti_gotovo;
...
import com.example.pochti_gotovo.databinding.ActivityMainAppBinding;
...
public class MainAppActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.appBarMainApp.fab.setOnClickListener(new View.OnClickListener() {
            @Override
